		...
		<div class="top-inner">
			...
			<div class="col-md-12 top-text" style="margin: 15px 0;">
				 ...
				 <div class="col-md-9 item-details">
				    <h4 class="top"><a href="">{{ $v->Ctitle }}</a></h4>
					...
					<div>
				    	<p>{{ $v->created_at }}<a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span>{{ $v->Ccomment or 0 }}</a><a class="span_link" href="#"><span class="glyphicon glyphicon-eye-open"></span>56 </a><a class="span_link" href="single.html"><span class="glyphicon glyphicon-circle-arrow-right"></span></a></p>
				    </div>
				 </div>
			 </div>
			@endforeach
